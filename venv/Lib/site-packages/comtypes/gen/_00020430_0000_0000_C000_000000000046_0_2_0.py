...
__all__ = [ 'FONTBOLD', 'OLE_YPOS_CONTAINER', 'Picture',
           'OLE_YPOS_PIXELS', 'IFont', 'FONTITALIC',
           'FONTSTRIKETHROUGH', 'OLE_CANCELBOOL',
           'OLE_XPOS_CONTAINER', 'Gray', 'OLE_COLOR',
           'OLE_ENABLEDEFAULTBOOL', 'Color', 'Checked', 'FONTNAME',
           'OLE_OPTEXCLUSIVE', 'LoadPictureConstants', 'Default',
           'StdFont', 'OLE_TRISTATE', 'Font', 'FONTSIZE', 'VgaColor',
           'OLE_YPOS_HIMETRIC', 'OLE_YSIZE_HIMETRIC', 'FontEvents',
           'OLE_XSIZE_PIXELS', 'Monochrome', 'OLE_YSIZE_PIXELS',
           'FONTUNDERSCORE', 'StdPicture', 'IFontDisp',
           'OLE_XPOS_HIMETRIC', 'IPicture', 'OLE_HANDLE',
           'OLE_YSIZE_CONTAINER', 'OLE_XSIZE_CONTAINER',
           'OLE_XPOS_PIXELS', 'OLE_XSIZE_HIMETRIC', 'Unchecked',
